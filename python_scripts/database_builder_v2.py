...
meta_bookings = Metadata(name = "bookings",
                    ...
                    columns = [
                            ...
                            {"name": "id", "type": "int64", "description": "The internal ID of the location"},
                            {"name": "time_from", "type": "date64", "description": "The start date and time of the booking in the time zone of the resource"},

                            {"name": "time_to", "type": "date64", "description": "The end date and time of the booking in the time zone of the resource"},

                            {"name": "location_id", "type": "int64", "description": "The internal ID of the booked resource"},
                            ...
                            {"name": "owner_id", "type": "int64", "description": "The id of the (internal) person to whom the booking is assigned. This person is also known as the meeting organiser."},
                            {"name": "booked_by_id", "type": "int64", "description": "The id of the user who created the booking."},
                            {"name": "organisation_id", "type": "int64", "description": "The ID of the host organisation. This is only applicable to customers using cross-organisation resource sharing."},
                            ...
                            {"name": "audit_created_created", "type": "date64", "description": "The specific history records for when the booking was created, approved, cancelled and checkedIn, as applicable to the booking. Cancelled bookings include those that required approval but were rejected."},
                            {"name": "audit_created_when", "type": "date64", "description": "The specific history records for when the booking was created, approved, cancelled and checkedIn, as applicable to the booking. Cancelled bookings include those that required approval but were rejected."},
                            ...
                            {"name": "audit_created_event_user_id", "type": "int64", "description": "The specific history records for when the booking was created, approved, cancelled and checkedIn, as applicable to the booking. Cancelled bookings include those that required approval but were rejected."},
                            {"name": "booking_group_id", "type": "int64", "description": "ID for repeat bookings"},
                            ...
                            {"name": "booking_group_repeat_start_date", "type": "date64", "description": "Date and time for start of the repeat of bookings"},
                            {"name": "booking_group_repeat_end_date", "type": "date64", "description": "Date and time for end of the repeat of bookings"},
                            ...
                            {"name": "audit_cancelled_created", "type": "date64", "description": "For cancelled events: Date and time for cancelled booking - created"},
                            {"name": "audit_cancelled_when", "type": "date64", "description": "For cancelled events: Date and time for cancelled booking - when (? Not clear from API doc)"},
                            {"name": "audit_cancelled_event_type", "type": "string", "description": "For cancelled events: Description of cancelled event type"},
                            {"name": "audit_cancelled_event_user_id", "type": "int64", "description": "For cancelled events: ID of user who cancelled booking"},
                            {"name": "source_version", "type": "string", "description": ""},
                            {"name": "is_booked_on_behalf", "type": "bool", "description": ""},
                            {"name": "audit_approved_created", "type": "date64", "description": "For approved events: Date and time created"},
                            {"name": "audit_approved_when", "type": "date64", "description": "For approved events: Date and time - when (? Not clear from API docs)"},
                            {"name": "audit_approved_event_type", "type": "string", "description": "For approved events: Description of approval event type"},
                            {"name": "audit_approved_event_user_id", "type": "int64", "description": "For approved events: ID of user who approved event"},
                            {"name": "audit_checked_in_created", "type": "date64", "description": "For checked in events: Date and time created"},
                            {"name": "audit_checked_in_when", "type": "date64", "description": "For checked in events: Date and time - when (? Not clear from API docs)"},
                            {"name": "audit_checked_in_event_type", "type": "string", "description": "For checked in events: Description of checked in event type"},
                            {"name": "audit_checked_in_event_user_id", "type": "int64", "description": "For checked in events: ID of user who approved event"},
                            {"name": "setup_time_from", "type": "date64", "description": "Not clear from API docs"},
                            {"name": "setup_time_to", "type": "date64", "description": "Not clear from API docs"},
                            {"name": "teardown_time_from", "type": "date64", "description": "Not clear from API docs"},
                            {"name": "teardown_time_to", "type": "date64", "description": "Not clear from API docs"},
...
meta_locations = Metadata(name = "locations",
                    ...
                    columns = [{"name": "id", "type": "int64", "description": "The internal ID of the location"},
                               {"name": "organisation_id", "type": "int64", "description": "The ID of the host organisation. This is only applicable to customers using cross-organisation resource sharing."},
                               {"name": "parent_id", "type": "int64", "description": "The internal ID of the parent location (hierarchy of locations)"},
                               {"name": "kind", "type": "string", "description": "The type of location (e.g. building, floor, zone, desk)"},
                               {"name": "capacity", "type": "int32", "description": "Capacity of location"},
                               {"name": "minimum_capacity", "type": "int32", "description": "Not included in API docs: Minimum capacity of location"},
                               ...
                               {"name": "external_reference", "type": "int64", "description": "Not included in API docs"},
                               {"name": "booking_category_id", "type": "int64", "description": "The id of the corresponding booking category for a bookable resource, such as a desk or meeting room"},
                               ...
                               {"name": "provider_id", "type": "int64", "description": "Not included in API docs"},
                               {"name": "provider_notificaftion_days_interval", "type": "int64", "description": "Not included in API docs"},
