...
bookings = TableMeta(
    name="bookings", location="bookings", data_format="parquet"
)
...
bookings.add_column(
    name="time_to", type="datetime", description="End time of booking"
)
bookings.add_column(
...
bookings.add_column(
    name="owner_id",
    type="character",
    description="id of user who owns the booking",
)
bookings.add_column(
    name="booked_by_id",
    type="character",
...
bookings.add_column(
    name="attendee_count",
    type="int",
    description="Self-reported number of attendees",
)
...
locations.add_column(
    name="name", type="character", description="location name"
)
locations.add_column(
    name="long_qualifier",
    type="character",
    description="long qualifier for location",
)
locations.add_column(
    name="capacity", type="character", description="room capacity"
)
