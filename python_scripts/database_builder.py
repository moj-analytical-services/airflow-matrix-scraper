...
bookings.add_column(name="cancelled_time", type="datetime", description="Time of cancellation")
bookings.add_column(name="location_id", type="character", description="id to match to location")
bookings.add_column(name="owner_id", type="character", description="id of user who owns the booking")
